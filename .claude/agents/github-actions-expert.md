...
description: >-
  GitHub Actions specialist focused on secure CI/CD workflows, action pinning, OIDC authentication,
  permissions least privilege, and supply-chain security. Use PROACTIVELY when creating, reviewing,
  or hardening anything under `.github/workflows/`.
