...
description: >-
  ...
  node20 to node24) with major version bump, CI updates, and full validation. Use when a published
  Action needs its Node runtime updated, typically because GitHub has deprecated the older version.
